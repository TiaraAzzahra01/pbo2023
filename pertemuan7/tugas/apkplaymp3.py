...
class MusicPlayerApp:
    def __init__(self, root):
        ...
        self.label = Label(root, text="TIARA AZZAHRA 220511001")
        self.label.pack(pady=20, padx=5)

        self.label = Label(root, text="Maximillian - On My Mind")
    ...
    def play_music(self):
        ...
        file_path = os.path.join(os.getcwd(), "tugas", "Maximillian - On My Mind.mp3")
